...
CREATE TABLE `db_sheet_task`  (
  ...
  `task_cardid` char(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '任务执行人员id',
  `group_id` int(11) NULL DEFAULT NULL COMMENT '任务组id',
  `task_type` int(10) NULL DEFAULT NULL COMMENT '任务类型 1-接受任务  2-抄送任务',
  `task_state` int(10) NULL DEFAULT NULL COMMENT '  0-任务未开始1-任务已开始  2-任务已拒绝',
  `task_main` int(10) NULL DEFAULT NULL COMMENT '任务主从关系 0-是发布人 1-非发布人',
