 ...
 * @description
 * @createTime 2019年07月18日 16:11:00
 * @Version v1.0
 */
public class AvatarUtils {
     ...
     * @throws IOException
     */
    public static BufferedImage generateImg(String name,int width,int height)
            throws IOException {
...
//            }
        ...
        if(nameWritten.length() >= 2) {
            ...
            if(isChinese(firstWritten)){
                ...
                g2.drawString(nameWritten.substring(nameLen - 1),40,73);
            }

//            //两个中文 如 言曌
//            if (isChinese(firstWritten) && isChinese(secondWritten)) {
//                g2.drawString(nameWritten, 26, 70);
//            }
//            //首中次英 如 罗Q
...
//            }
        ...
        if(nameWritten.length() ==1) {
            ...
            if(isChinese(nameWritten)) {
                ...
                g2.setFont(font);
                g2.drawString(nameWritten, 33, 73);
            }
            //英文
            else {
        ...
        return makeRoundedCorner(bi, 120);
    }
